...
const LegalNotice: React.FC = () => {
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Montserrat, sans-serif" }}>
      ...
      <p className="texto">8.2. Derecho de rectifiacaccccación: Derecho a solicitar la modificación de tus datos personales por ser éstos inexactos, no veraces o desactualizados.</p>
